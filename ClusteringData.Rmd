...
####Reading data
dat <- read.csv("/Users/AkashMitra/Desktop/RotationTwo/FW__Pre_post_Rx_RPPA_data/jh0008-normalized-148Ab.csv", header=T)
...
####Reading data
dat <- read.csv("/Users/AkashMitra/Desktop/RotationTwo/FW__Pre_post_Rx_RPPA_data/jh0013-medCentered-179Ab.csv", header =T)
...
####Reading data
dat <- read.csv("/Users/AkashMitra/Desktop/RotationTwo/FW__Pre_post_Rx_RPPA_data/jh0014-medCentered-176Ab.csv", header =T)
d <- as.matrix.data.frame(dat[,-c(1,2,3,4,5,6,7)])
...
####Reading data
dat <- read.csv("/Users/AkashMitra/Desktop/RotationTwo/FW__Pre_post_Rx_RPPA_data/rppa-printJH0012-medCntrNormalized.csv", header =T)
d <- as.matrix.data.frame(dat[,-c(1,2,3,4,5,6,7)])
